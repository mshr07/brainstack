    ...
    (<div className="  flex items-center justify-center">
      <Modal>
        ...
        <ModalBody>
          <ModalContent>
            <h4
              className="text-lg md:text-2xl text-neutral-100 font-bold text-center mb-2">
              Welcome to Elevyra!
            </h4>
          
            <div
              className="pt-6 flex flex-wrap gap-x-4  items-start justify-start max-w-sm mx-auto">
                <FormComp />
            </div>
          </ModalContent>
